...
TRACKING_STATUS = {
    ...
    ("BDE", 4): (
        "delivery_rejected",
        "Cliente recusou-se a receber o objeto - Entrega não realizada",
    ...
    ("BDE", 6): (
        "delivery_unsuccessful",
        "Cliente desconhecido no local - Entrega não realizada",
        "Objeto será devolvido ao remetente",
        "Acompanhar o retorno do objeto ao remetente.",
    ),
    ("BDE", 7): (
    ...
    ("BDE", 14): ("returning_to_sender", "Desistência de postagem pelo remetente", "", "Acompanhar"),
    ("BDE", 15): (
        "shipped",
    ...
    ("BDE", 23): ("returned", "Objeto entregue ao remetente", "", "Acompanhar"),
    ...
    ("BDE", 44): (
        ...
        "Aguardando órgão anuente apresentar documentação fiscal",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("BDE", 45): (
    ...
    ("BDE", 60): (
        "customs_control",
        "Objeto encontra-se aguardando prazo para refugo",
        "",
        "Acompanhar",
    ),
    ("BDE", 61): (
        "customs_control",
        "Objeto refugado",
        "Devolução proibida por órgão anuente ou não contratada pelo remetente",
        "Acompanhar",
    ),
    ("BDE", 62): (
        "returning_to_sender",
        "Em devolução à origem por determinação da Receita Federal",
        "Objeto poderá ser devolvido à origem ou encaminhado para refugo de acordo com orientação do remetente",
        "Acompanhar",
    ),
    ("BDE", 66): (
        "shipped_delayed",
    ...
    ("BDE", 81): (
        "shipped",
        "Não foi autorizada a saída do objeto do país pelos órgãos fiscalizadores",
        "Objeto em análise de destinação - poderá ser devolvido ao remetente, encaminhado para refugo ou apreendido",
        "Acionar atendimento dos Correios.",
    ),
    ("BDE", 82): (
        "shipped",
        "Necessário complementar endereço de entrega",
        "Acesse o Fale Conosco > Reclamação > Objeto em processo de desembaraço",
        "Acionar atendimento dos Correios.",
    ),
    ("BDE", 83): (
        "seized_for_inspection",
        "Ação necessária à liberação do objeto não realizada pelo cliente",
        "Objeto em análise de destinação - poderá ser devolvido ao remetente, encaminhado para refugo ou apreendido",
        "Acionar atendimento dos Correios.",
    ),
    ("BDE", 84): ("shipped", "Verificando situação do objeto", "Por favor, aguarde", "Acompanhar"),
    ("BDE", 85): ("shipped", "Código do objeto fora do padrão", "Objeto será entregue sem rastreamento", "Acompanhar"),
    ("BDE", 86): (
        "lost",
        "Objeto com conteúdo avariado",
        "Favor entrar em contato com os Correios.",
        "Acionar atendimento dos Correios.",
    ),
    ("BDE", 87): (
    ...
    ("BDE", 98): ("lost", "Objeto não localizado no fluxo postal", "", "Acompanhar"),
    ("BDI", 0): (
        "delivered",
        "Objeto entregue ao destinatário",
        "Recebido por:",
    ...
    ("BDI", 84): (
        "seized_for_inspection",
        "Verificando situação do objeto",
        "Por favor, aguarde",
        "Acompanhar.",
    ),
    ("BDI", 85): ("shipped", "Código do objeto fora do padrão", "Objeto será entregue sem rastreamento", "Acompanhar"),
    ("BDI", 86): (
        "lost",
        "Objeto com conteúdo avariado",
        "Favor entrar em contato com os Correios.",
    ...
    ("BDI", 87): ("shipped", "Objeto destinado a outro país", "", "Acompanhar"),
    ...
    ("BDR", 31): ("shipped", "Pagamento confirmado", "Entrega em até 40 dias úteis.", "Acompanhar"),
    ...
    ("BDR", 63): (
        "returning_to_sender",
        "Pagamento não efetuado no prazo",
        "Objeto em análise de destinação",
        "Acompanhar",
    ),
    ("BDR", 64): (
        ...
        "O objeto será devolvido ao remetente",
        "Acompanhar",
    ),
    ("BDR", 66): (
        "shipped_delayed",
    ...
    ("BDR", 84): ("shipped", "Verificando situação do objeto", "Por favor, aguarde", "Acompanhar"),
    ("BDR", 85): ("shipped", "Código do objeto fora do padrão", "Objeto será entregue sem rastreamento", "Acompanhar"),
    ("BDR", 86): (
        "lost",
        "Objeto com conteúdo avariado",
        "Favor entrar em contato com os Correios.",
    ...
    ("BLQ", 4): ("shipped", "Bloqueio", "", "Acompanhar"),
    ("BLQ", 5): (
        "returning_to_sender",
        "Solicitação de suspensão de entrega recebida",
        "Objeto deve retornar ao Centro Internacional",
        "Acompanhar",
    ),
    ("BLQ", 11): (
        "shipped",
    ...
    ("BLQ", 22): ("returning_to_sender", "Solicitação de suspensão de entrega recebida", "", "Acompanhar"),
    ("BLQ", 24): ("shipped", "Desbloqueio de objeto indenizado", "", "Acompanhar"),
    ("BLQ", 30): ("seized_for_inspection", "Bloqueio teste", "", "Acionar atendimento dos Correios."),
    ("BLQ", 31): ("lost", "Extravio varejo pós-indenizado", "", "Acionar atendimento dos Correios."),
    ("BLQ", 41): ("seized_for_inspection", "Bloqueio SEGOPE 4/1", "", "Acionar atendimento dos Correios."),
    ("BLQ", 42): ("seized_for_inspection", "Bloqueio SEGOPE 4/", "", "Acionar atendimento dos Correios."),
    ("BLQ", 44): (
        "seized_for_inspection",
        "Desbloqueio de objeto com conteúdo proibido/perigoso",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("BLQ", 51): (
        "seized_for_inspection",
        "Objeto bloqueado por necessidade de revisão de impostos/tributos",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("BLQ", 54): (
        "seized_for_inspection",
        "Desbloqueio de objeto com revisão de impostos/tributos",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("BLQ", 61): ("seized_for_inspection", "Desbloqueado", "", "Acionar atendimento dos Correios."),
    ...
    ("CO", 2): ("shipped", "A coletar", "", "Acompanhar"),
    ("CO", 3): ("shipped", "Coletando", "", "Acompanhar"),
    ("CO", 4): ("shipped", "Pedido Transferido", "", "Acompanhar"),
    ("CO", 5): ("shipped", "1ª Tentativa de Coleta", "", "Acompanhar"),
    ("CO", 6): ("shipped", "2ª Tentativa / Coleta Cancelada", "", "Acompanhar"),
    ("CO", 7): ("shipped", "Aguardando Objeto na Agência", "", "Acompanhar"),
    ("CO", 8): (
        "delivered",
        "Entregue",
        "",
    ...
    ("CO", 9): ("returned", "Coleta Cancelada", "", "Acompanhar"),
    ("CO", 10): ("returned", "Desistência do Cliente ECT", "", "Acompanhar"),
    ("CO", 11): (
        "lost",
        "Objeto Sinistrado",
        "",
    ...
    ("ERROR", 0): ("error", "Objeto não encontrado", "", ""),
    ...
    ("FC", 11): (
        "damaged",
        "Objeto destruído com autorização do remetente",
        "",
        "Acompanhar",
    ),
    ("FC", 12): (
        "seized_for_inspection",
        "Objeto encaminhado para fiscalização - ANVISA",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("FC", 13): (
        "seized_for_inspection",
        "Fiscalizado ANATEL",
        "Seguir orientações do site da ANATEL. Prazo: 10 dias corridos",
        "Acionar atendimento dos Correios.",
    ),
    ("FC", 19): (
        "seized_for_inspection",
        "Objeto encaminhado para fiscalização - ANATEL",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("FC", 24): (
    ...
    ("FC", 26): (
        "seized_for_inspection",
        "RFB - Objeto Tributado - Emissão da nota de tributação",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("FC", 27): (
        "seized_for_inspection",
        "Objeto encaminhado para emissão de DSI",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ...
    ("FC", 31): (
        "seized_for_inspection",
        "Aguardando autorização para exportação",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("FC", 32): (
        "seized_for_inspection",
        "Objeto encaminhado para fiscalização - INMETRO",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("FC", 33): (
        "seized_for_inspection",
        "Objeto encaminhado para fiscalização - Polícia Federal",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("FC", 34): (
        "seized_for_inspection",
        "Objeto encaminhado para fiscalização - VIGIAGRO",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("FC", 35): (
        "seized_for_inspection",
        "Objeto encaminhado para fiscalização - Exército",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("FC", 37): (
        "seized_for_inspection",
        "Objeto encaminhado para fiscalização - IBAMA",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("FC", 41): (
        "seized_for_inspection",
        "Problemas na documentação do objeto",
        "Procure a agência de postagem em até 2 dias úteis",
        "Acionar atendimento dos Correios.",
    ),
    ("FC", 42): (
        "seized_for_inspection",
        "Objeto contém líquido, impossibilitando seu transporte",
    ...
    ("FC", 55): (
        "damaged",
        "Encomenda unitizada finalizada",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ...
    ("LDI", 1): (
        "awaiting_pickup_by_receiver",
        "Objeto aguardando retirada no endereço indicado",
        "Para retirá-lo, é preciso informar o código do objeto e apresentar documentação que comprove ser o "
        "destinatário ou pessoa por ele oficialmente autorizada.",
        "Acompanhar. O interessado deverá buscar o objeto em uma Unidade dos Correios.",
    ),
    ("LDI", 2): (
        "awaiting_pickup_by_receiver",
    ...
    ("PAR", 12): (
        "seized_for_inspection",
        "Informações prestadas pelo cliente em análise",
        "",
        "Acionar atendimento dos Correios.",
    ),
    ("PAR", 13): (
    ...
    ("PAR", 19): ("customs_control", "Fiscalização aduaneira finalizada no país de destino", "", "Acompanhar."),
    ("PAR", 20): (
        "customs_control",
        "Objeto recebido pelos Correios do Brasil com embalagem danificada",
        "Por favor, aguarde",
        "Acompanhar.",
    ),
    ("PAR", 21): ("customs_control", "Encaminhado para fiscalização aduaneira", "", "Acompanhar."),
    ("PAR", 22): ("customs_control", "Encaminhado para fiscalização no país de destino", "", "Acompanhar."),
    ("PAR", 23): (
        "customs_control",
        "Aguardando autorização da Receita Federal para devolução do objeto ao remetente",
        "",
        "Acompanhar.",
    ),
    ("PAR", 24): ("customs_control", "Devolução autorizada pela Receita Federal", "", "Acompanhar."),
    ("PAR", 25): ("customs_control", "Faltam informações. Sua ação é necessária", "", "Acompanhar."),
    ("PAR", 26): ("customs_control", "Destinatário recusou o objeto", "Objeto em análise de destinação", "Acompanhar."),
    ("PAR", 27): ("customs_control", "Despacho Postal pago na origem", "", "Acompanhar."),
    ("PAR", 28): ("customs_control", "Encaminhado para a unidade de tratamento", "", "Acompanhar."),
    ("PAR", 29): ("customs_control", "PAR 29", "", "Acompanhar."),
    ("PAR", 30): ("customs_control", "Aguardando pagamento do despacho postal", "", "Acompanhar."),
    ("PAR", 31): ("customs_control", "Pagamento confirmado", "", "Acompanhar."),
    ("PAR", 32): ("customs_control", "Aguardando confirmação de pagamento pela operadora", "", "Acompanhar."),
    ("PAR", 33): (
        "customs_control",
        "Pagamento não confirmado pela operadora",
        "Entre em contato com sua operadora",
        "Acompanhar.",
    ),
    ("PAR", 34): ("customs_control", "Liberado sem tributação", "", "Acompanhar."),
    ("PAR", 40): ("customs_control", "Devolução a pedido", "Cliente solicitou a devolução da encomenda", "Acompanhar."),
    ("PAR", 41): ("customs_control", "Prazo de pagamento encerrado", "Objeto em análise de destinação", "Acompanhar."),
    ("PAR", 42): ("customs_control", "Objeto liberado", "", "Acompanhar."),
